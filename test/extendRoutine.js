...
describe('extendRoutine', () => {
  ...
  it('should create an extened routine if input is a prefix', () => {

    const routine = extendRoutine(PREFIX, ['SOME_LONG_TYPE', 'OTHER']);
  ...
  it('should create extened routine if types arg is string if input is a prefix', () => {

    const routine = extendRoutine(PREFIX, 'SOME_LONG_TYPE');
  ...
  it('should create extened routine with provided payload creators  if input is a prefix', () => {
  ...
  it('should create new routine with provided meta creator if input is a prefix', () => {
    const triggerMeta = { test: 'triggerMeta' };
    const requestMeta = { test: 'requestMeta' };
    const successMeta = { test: 'successMeta' };
    const failureMeta = { test: 'failureMeta' };
    ...
    const routine = extendRoutine(PREFIX, 'SOME_LONG_TYPE', (payload) => payload, {
      trigger: () => triggerMeta,
      request: () => requestMeta,
      success: () => successMeta,
      failure: () => failureMeta,
